        ...
        <div class="container-fluid">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id="ngofollowers">
                        <?php 
                        include "../login_system/db_conn.php";
                        $query = 'select id from payment where payment_status = "pending" '; 
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Payment Success</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id="collect_amount">
                        <?php 
                        include "../login_system/db_conn.php";
                        $query = 'select id from payment where payment_status = "complete" '; 
                        $query_run = mysqli_query($conn,$query);
                        $row = mysqli_num_rows($query_run);
                        echo $row;
                        ?>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 font-weight-bold text-gray-800" id="postcount">
                             <?php 
                        include "../login_system/db_conn.php";
                        $query = 'select id from payment order by id '; 
                        $query_run = mysqli_query($conn,$query);
                        $row = mysqli_num_rows($query_run);
                        echo $row;
                        ?>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id="donate">
                            <?php 
                        include "../login_system/db_conn.php";
                        $query = 'select id from payment where payment_status = "complete"  order by id '; 
                        $query_run = mysqli_query($conn,$query);
                        $row = mysqli_num_rows($query_run);
                        echo $row*500;
                        ?>
          ...
          <div class="row">
            <!-- <div class="col-lg-6">
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Global App User</h6>
                </div>
                <div class="card-body">
